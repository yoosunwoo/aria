package company.aria.common.log;
...
public class LoggingAdvice {
	...
	// target �޼����� �Ķ���͵� ������ ����մϴ�.
	@Before("execution(* company.aria.*.service.*.*(..)) or "
			+ "execution(* company.aria.*.dao.*.*(..))")
	...
	@After("execution(* company.aria.*.service.*.*(..)) or "
			+ "execution(* company.aria.*.*.dao.*.*(..))")
	...
	// target �޼ҵ��� ���� �ð��� �����մϴ�.
	@Around("execution(* company.aria.*.service.*.*(..)) or "
			+ "execution(* company.aria.*.dao.*.*(..))")
