    ...
    <div class="left_menu">
        ...
        <ul class="list">
            ...
            <li id="course" class="icon01">
                <a href="${contextPath}/bupage/modbu.do" class="dropdown-toggle">사업자 정보 수정</a>
            </li>
            
            <li id="certificate" class="icon02 none_sMenu">
                <a href="../mypage/certificate_list.jsp" class="dropdown-toggle">이용내역 조회</a>
            </li>
            
            <li id="order" class="icon03">
                <a href="#" class="dropdown-toggle">문의내역 조회</a>
            </li>
            
            <li id="coupon" class="icon04 none_sMenu">
                 <a href="#" id="next2">사업자 매장 등록</a>
            </li>
            	<script>
            		$('#next2').click(function(e) {
            		  ...
            		  var form = $('<form>', {
            		    method: 'post',
            		    action: '${contextPath}/bupage/bupageSelectStore.do'
            		  });
            ...
            <li id="coupon" class="icon04 none_sMenu">
            	...
            	<script>
            		$('#next3').click(function(e) {
            		  ...
            		  var form = $('<form>', {
            		    method: 'post',
            		    action: '${contextPath}/test/testPage3.do'
            		  });
            		  form.appendTo('body').submit();
            		});
        ...
        <script type="text/javascript">
  		 function deletemember(_login_id){
    		  if(confirm("회원탈퇴하시겠습니까")){
		         ...
		         formObj.method="post";
		         formObj.action="${contextPath}/bupage/deletemember.do";
		         formObj.submit();
		      }else{
		         alert("탈퇴취소")
		  }
