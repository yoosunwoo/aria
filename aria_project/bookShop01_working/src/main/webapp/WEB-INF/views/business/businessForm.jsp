...
<body>
        ...
        <form action="${contextPath}/business/addMember.do" method="post" onsubmit="return rt()">
    <div class="member">
    
    <div class="mem">
    
        <h1 id="hd">사업자 회원가입</h1>

        <!-- 1. 아이디 -->
       <div class="field tel-number">
            <b>아이디</b>
            <div>
            <input type="text"  name="bu_id" id="_business_id"  />
            <input type="hidden" name="_bu_id" id="business_id" />
            <input type="button" id="btnOverlapped" value="중복확인" onClick="fn_overlapped()" />
 			</div>   
 			</div>
        <div class="field">
            <b>비밀번호</b>
            <input name="bu_pw" id="business_pw" type="password" />
        </div>
        <div class="field tel-number">
            <b>비밀번호 확인</b>
            <div>
             <input id="business_pw1" type="password"/> <input type="button" onclick="test()" value="확인" />       
        </div>
        </div>
        
         <div class="field">
						<b>주민번호</b>
						<input id="hp" type="text" name="bu_ssn1"> - <input id="hp" type="text" name="bu_ssn2">
		</div>
...
<div class="field">
            <b>이메일</b>
				...
				<input id="_bu_email1" type="text"  name="_bu_email1"> @  
                <input id="bu_email2" type="text"  name="bu_email2">
             ...
             <input type="hidden" name="bu_email1" id="bu_email1" />
        ...
        <div class="field">
            <b>휴대폰 번호</b>
						<select id="tl" name="bu_phone1">
							...
							id="tl" type="tel" name="bu_phone2"> - 
							<input
							id="tl" type="tel" name="bu_phone3">
        </div>
      </div>
        ...
        <div class="field tel-number">
            <b>주소</b>
            <div>
            <input type="text" id="zipcode" name="bu_zipcode" >
            <input type="button" onclick="javascript:execDaumPostcode()" value="우편번호 검색">
 			</div> 
            
                <input type="text" id="roadAddress" name="bu_address1" placeholder="도로명 주소"> 
           <!--  <input type="text" id="jibunAddress" name="jibunAddress" placeholder="지번 주소"> -->
              <input type="text" name="bu_address2" placeholder="상세 주소">
            
        </div>
         <div class="field">
            <b>상호명</b>
            <input type="text" name="bu_name">
        </div>
        
         <div class="field">
            <b>사업자 번호</b>
            <input type="text" name="bu_bn">
        </div>
        ...
        <div style="margin-bottom:15px;">
            <b>사업 선택</b>
            <div id="ser">
            <label><input type="checkbox" name="bu_lack_yes" value="Y" checked="checked">결식 서비스<span style="padding-left: 30px"></span></label>
			<label><input type="checkbox" name="bu_care_yes" value="Y">돌봄 서비스<span style="padding-left: 30px"></span></label> 
			<label><input type="checkbox" name="bu_female_yes" value="Y">보건위생 서비스</label>			
			</div>				
        </div>
