...
function calcGoodsPrice(bookPrice,obj,dePrice){
	   var totalPrice,final_total_price,totalNum,totalDelivery;
	   ...
	   //   alert("체크 했음")
	      ...
	      totalDelivery=Number(h_totalDelivery.value)+ dePrice;
	   ...
	   h_totalDelivery.value=totalDelivery;
	   ...
	   p_totalDelivery.innerHTML=totalDelivery + "원";
	}
			...
			<tr style="background:#33ff00" >
			 ...
			 <tr>       
               <form name="frm_order_all_cart">
					...
					<td><input type="checkbox" name="checked_goods"  checked  value="${item.goods_id }"  onClick="calcGoodsPrice(${item.goods_sales_price*0.9*cart_goods_qty },this,${item.goods_delivery_price})"></td>
