...
<c:when test="${side_menu=='my_page' }">
	...
	<li>
		...
		<ul>
			...
			<li><a href="javascript:deletemember('${login_id}')">회원탈퇴</a></li>
		</ul>
	</li>
</c:when>
<c:otherwise>
	<li>
		...
		<ul>
			...
			<li><a href="${contextPath}/goods/searchGoods.do?searchWord=자기계발">자기계발</a></li>
			<li><a href="${contextPath}/goods/searchGoods.do?searchWord=자연과학">자연과학/공학</a></li>
			<li><a href="${contextPath}/goods/searchGoods.do?searchWord=역사">역사/인문학</a></li>
		</ul>
	</li>
	<li>
		<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;음반</h3>
