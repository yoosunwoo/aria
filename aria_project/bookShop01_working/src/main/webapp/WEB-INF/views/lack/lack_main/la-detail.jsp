...
.topnav ul{border-bottom: 1px solid #666666;  margin-bottom: 10px; }
...
.storeboard {display: grid;grid-template-columns: repeat(4, 1fr);grid-gap: 0px;   }
.storeboard img{display: block;width: 100%;height: 200px;   }
...
<body>
   ...
   <div class="storeboard">
		<img src="${contextPath}/resources/image/bk1.jpg">   
		<img src="${contextPath}/resources/image/bk2.jpg">   
		<img src="${contextPath}/resources/image/bk4.jpg">   
		<img src="${contextPath}/resources/image/bk5.png">   
   </div>
   
   <div class="menuboard">
      <c:forEach items="${goodsMap2.lm_ls_storeName}" var="list">
