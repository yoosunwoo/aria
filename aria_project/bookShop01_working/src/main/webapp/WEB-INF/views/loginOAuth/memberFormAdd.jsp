...
<body>
<c:choose>
	<c:when test="${empty memberInfoAdd }">
		<form action="${contextPath}/loginOAuth/addMemberByKakao.do" method="post" onsubmit="return rt()" >
	</c:when>
	<c:otherwise>
		<form action="${contextPath}/loginOAuth/updateMemberByKakao.do" method="post">
	</c:otherwise>
</c:choose>
    <div class="member">
    	...
    	<div class="mem">
                ...
                <h1 id="hd">원활한 서비스 이용을 위해<br> 추가 정보를 기입해주세요<br>*표시는 필수 항목입니다.</h1>

        <!-- 1. 아이디 -->
      <div class="field tel-number">
            <b>아이디 <span>(*)</span><br><span style="color:#ff9999">사이트에서 사용하실 ID를 입력해주세요!</span></b>
            <div>
            <input type="text"  name="_member_id" id="_member_id" value="${memberInfoAdd.me_id }" />
            <input type="hidden" name="me_id" id="member_id" value="${memberInfoAdd.me_id }" />
 		...
 		<c:choose>
 			<c:when test="${empty memberInfoAdd }">
 				<div class="field">
 					<b>비밀번호 <span>(*)</span><br><span style="color:#ff4444">간편로그인이 아닌 일반 로그인 시에 사용하실 비밀번호를 입력하세요!</span></b>
 			...
 			<c:otherwise>
 				<div class="field">
 					<b>비밀번호 <span>(*)</span><br><span style="color:#ff4444">간편로그인이 아닌 일반 로그인 시에 사용하실 비밀번호를 입력하세요!</span></b>
 					<input name="me_pw" id="member_pw" type="password" value="${memberInfoAdd.me_pw }" readonly/>
 				</div>
 			</c:otherwise>
 		</c:choose>	 
        ...
        <div class="field">
			<b>주민번호</b>
			<input id="hp" type="text" name="me_ssn1" value="${memberInfoAdd.me_ssn1 }"> - <input id="hp" type="text" name="me_ssn2"value="${memberInfoAdd.me_ssn2 }">
		</div>
        
         <!-- 4. 이름 -->
        <div class="field">
        	<b>이름 <span>(*)</span></b>
            <input type="text" name="me_name" value="${properties.nickname }">
		</div>
        ...
        <div class="field gender">
        	<b>성별</b>
            	...
            	<c:choose>
            		...
            		<c:otherwise>
            			<c:if test="${memberInfoAdd.me_gender == 'female' }">
            				<label><input type="radio" name="me_gender" value="male">남자<span style="padding-left: 100px"></span></label>
                			<label><input type="radio" name="me_gender" value="female" checked="checked">여자</label>
            			</c:if>
            			<c:if test="${memberInfoAdd.me_gender == 'male' }">            			
            				<label><input type="radio" name="me_gender" value="male" checked="checked">남자<span style="padding-left: 100px"></span></label>
                			<label><input type="radio" name="me_gender" value="female">여자</label>
            			</c:if>
            		</c:otherwise>
	...
	<c:choose>
		...
		<c:otherwise>
			<div class="field">
				<b>이메일</b>
				<input style="background:lightgray" name="emailByKakao" type="text" value="${properties.email }" readonly>
				<input type="hidden" name="me_email1" id="me_email1" value="${fn:split(properties.email,'@')[0] }">
				<input type="hidden" name="me_email2" id="me_email1" value="${fn:split(properties.email,'@')[1] }">
				<%-- <input type="hidden" name="me_email" id="me_email1" value="${properties.email }"> --%>
			</div>
		</c:otherwise>
	</c:choose>     
</div>
	...
	<div class="mem">
        ...
        <div class="field">
            <b>휴대폰 번호</b>
						<select id="tl" name="me_phone1">
							...
							id="tl" type="tel" name="me_phone2" value="${memberInfoAdd.me_phone2 }"> - 
							<input
							id="tl" type="tel" name="me_phone3" value="${memberInfoAdd.me_phone3 }">
        </div>
     </div>
     ...
     <div class="mem">
         ...
         <div class="field tel-number">
            <b>주소</b>
            <div>
            <input type="text" id="zipcode" name="me_zipcode" value="${memberInfoAdd.me_zipcode }" >
            <input type="button" onclick="javascript:execDaumPostcode()" value="우편번호 검색">
 			</div> 
            
                <input type="text" id="roadAddress"
									name="me_address1" placeholder="도로명 주소" value="${memberInfoAdd.me_address1 }"> 
              <!--  <input type="text" id="jibunAddress" name="jibunAddress" placeholder="지번 주소"> -->
              <input type="text" id="detailAdddress"  name="me_address2" placeholder="상세 주소" value="${memberInfoAdd.me_address2 }">
        ...
        <div style="margin-bottom:15px;">
            <b>서비스 선택</b>
            <div id="ser">
            	<input type="hidden" id="h_me_lack_yes" value="${memberInfoAdd.me_lack_yes }">
            	<input type="hidden" id="h_me_care_yes" value="${memberInfoAdd.me_care_yes }">
            	<input type="hidden" id="h_me_female_yes" value="${memberInfoAdd.me_female_yes }">
            ...
            <label><input type="checkbox" id="me_lack_yes" name="me_lack_yes" value="Y">결식 서비스<span style="padding-left: 30px"></span></label>
			<label><input type="checkbox" id="me_care_yes" name="me_care_yes" value="Y">돌봄 서비스<span style="padding-left: 30px"></span></label> 
			<label><input type="checkbox" id="me_female_yes" name="me_female_yes" value="Y">보건위생 서비스</label>			
			</div>				
        </div>
