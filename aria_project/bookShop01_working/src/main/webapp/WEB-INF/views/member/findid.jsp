...
<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
  ...
  <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle" style="width:25rem;">
		...
		<div class="card-body">
      <form action="${contextPath}/member/findid.do" class="form-signin" method="POST">
  		 <p class="text2"> ${findid2}</p>
        <input type="text" name="me_name" id="name" class="form-control" placeholder="이름" required autofocus><BR>
        ...
        <div class="links">
            ...
            <a href="${contextPath}/member/pw_find.do">비밀번호 찾기</a> | <a href="${contextPath}/member/login.do">로그인</a> | <a href="${contextPath}/member/memberFormSelect.do">회원가입</a>
