...
<body>
    <form action="${contextPath}/mypage/updateMember.do" method="post" onsubmit="return rt()" >
    <div class="member">
    
    	<div class="mem">
        
        <h1 id="hd">회원 정보 수정</h1>

        <!-- 1. 아이디 -->
      <div class="field tel-number">
            <b>아이디</b>
            <div>
            <input type="text"  name="me_id" id="_member_id" value="${memberInfo.me_id}" readonly="readonly" />
 			</div>   
 			</div>
 			 <!-- 2. 비밀번호 -->
        <div class="field">
            <b>비밀번호</b>
            <input name="me_pw" id="member_pw" type="text" value="${memberInfo.me_pw}"/>
        </div>
        <div class="field tel-number">
            <b>비밀번호 확인</b>
            <div>
             <input id="member_pw1" type="text" value="${memberInfo.me_pw}"/> <input type="button" onclick="test()" value="확인" />       
        </div>
        </div>
        ...
        <!-- 3. 주민번호 -->
          <div class="field">
						<b>주민번호</b>
						<input id="hp" type="text" name="me_ssn1" value="${memberInfo.me_ssn1}"> - <input id="hp" type="text" name="me_ssn2" value="${memberInfo.me_ssn2}">
		</div>
        
         <!-- 4. 이름 -->
         <div class="field">
            <b>이름</b>
            <input id="nam" type="text" name="me_name" value="${memberInfo.me_name}">
        </div>
        ...
        <!-- 5. 성별 -->
          <div class="field gender">
            ...
            <c:choose>
            		...
            		<c:otherwise>
            			<c:if test="${memberInfo.me_gender == 'female' }">
            			...
            			<c:if test="${memberInfo.me_gender == 'male' }">            			
            				<label><input type="radio" name="me_gender" value="male" checked="checked">남자<span style="padding-left: 100px"></span></label>
                			<label><input type="radio" name="me_gender" value="female">여자</label>
            			</c:if>
            		</c:otherwise>
...
<div class="field">
            <b>이메일</b>
                ...
                <input id="_me_email1" type="text"  name="_me_email1" value="${memberInfo.me_email1}"> @  
                <input id="me_email2" type="text"  name="me_email2" value="${memberInfo.me_email2}">
	...
	<div class="mem">
        ...
        <div class="field">
            <b>휴대폰 번호</b>
						...
						<input id="tl" type="tel" name="me_phone2" value="${memberInfo.me_phone2}"> - <input id="tl" type="tel" name="me_phone3" value="${memberInfo.me_phone3}">
        </div>
     </div>
     ...
     <div class="mem">
         ...
         <div class="field tel-number">
            <b>주소</b>
            <div>
            <input type="text" id="zipcode" name="me_zipcode" value="${memberInfo.me_zipcode}" >
            <input type="button" onclick="javascript:execDaumPostcode()" value="우편번호 검색">
 			</div> 
            
                <input type="text" id="roadAddress" name="me_address1" placeholder="도로명 주소" value="${memberInfo.me_address1}"> 
              <!--  <input type="text" id="jibunAddress" name="jibunAddress" placeholder="지번 주소"> -->
              <input type="text" id="detailAdddress" name="me_address2" placeholder="상세 주소" value="${memberInfo.me_address2}">
        ...
        <div style="margin-bottom:15px;">
            <b>서비스 선택</b>
            <div id="ser">
            	<input type="hidden" id="h_me_lack_yes" value="${memberInfo.me_lack_yes }">
            	<input type="hidden" id="h_me_care_yes" value="${memberInfo.me_care_yes }">
            	<input type="hidden" id="h_me_female_yes" value="${memberInfo.me_female_yes }">
